...
using LockthreatCompliance.MultiTenancy.HostDashboard;
...
namespace LockthreatCompliance.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(LockthreatComplianceDbContext context, SubscriptionPayment subscriptionPayment)
        {
