...
namespace LockthreatCompliance.Tests.Features
{
    ...
    public class Features_Tests : AppTestBase
    {
        ...
        public async Task Should_Not_Create_User_More_Than_Allowed_Count()
        {
            ...
            exception.Message.ShouldContain(_localizationManager.GetString(LockthreatComplianceConsts.LocalizationSourceName, "MaximumUserCount_Error_Message"));
        }
    }
}
