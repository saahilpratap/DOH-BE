...
namespace LockthreatCompliance.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<LockthreatComplianceDbContext>>()
            ...
            new LockthreatComplianceDbContext(builder.Options).Database.EnsureCreated();
        }
