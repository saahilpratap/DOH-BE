...
using LockthreatCompliance.EntityFrameworkCore.Repositories;

namespace LockthreatCompliance.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : LockthreatComplianceRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<LockthreatComplianceDbContext> dbContextProvider)
