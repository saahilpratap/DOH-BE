...
{
    public partial class updateExtAssSCH_Tbl : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ExtAssSchAuthoritativeDocuments",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AuthoritativeDocumentId = table.Column<int>(nullable: false),
                    ExternalAssessmentScheduleId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtAssSchAuthoritativeDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExtAssSchAuthoritativeDocuments_AuthoritativeDocuments_AuthoritativeDocumentId",
                        column: x => x.AuthoritativeDocumentId,
                        principalTable: "AuthoritativeDocuments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExtAssSchAuthoritativeDocuments_ExternalAssessmentSchedules_ExternalAssessmentScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExtAssSchAuthoritativeDocuments_AuthoritativeDocumentId",
                table: "ExtAssSchAuthoritativeDocuments",
                column: "AuthoritativeDocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_ExtAssSchAuthoritativeDocuments_ExternalAssessmentScheduleId",
                table: "ExtAssSchAuthoritativeDocuments",
