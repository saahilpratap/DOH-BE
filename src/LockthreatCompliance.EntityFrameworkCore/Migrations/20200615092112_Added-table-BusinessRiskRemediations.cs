...
{
    public partial class AddedtableBusinessRiskRemediations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "BusinessRiskRemediations",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessRiskRemediations", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_BusinessRiskRemediations_Remediations_RemediationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessRiskRemediations_RemediationId",
                table: "BusinessRiskRemediations",
