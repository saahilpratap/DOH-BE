...
namespace LockthreatCompliance.Migrations
{
    ...
    [Migration("20200616080930_update-table-incident-closedate-colums")]
    partial class updatetableincidentclosedatecolums
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LockthreatCompliance.AuditProjects.AuditChecklist", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("AuditChecklists");
                });

            modelBuilder.Entity("LockthreatCompliance.AuditProjects.AuditChecklistType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("LockthreatCompliance.AuditProjects.AuditDocSubModelPath", b =>
                {
                    ...
                    b.Property<long?>("AuditChecklistId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("AuditTemplateId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LockthreatCompliance.AuditProjects.AuditProject", b =>
                {
                    ...
                    b.Property<long?>("AuditMamangerId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LockthreatCompliance.AuditProjects.AuditTemplate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("LockthreatCompliance.AuditProjects.AuditChecklistType", b =>
                {
                    b.HasOne("Abp.DynamicEntityParameters.DynamicParameterValue", "ChecklistType")
                        .WithMany()
            ...
            modelBuilder.Entity("LockthreatCompliance.AuditProjects.AuditDocSubModelPath", b =>
                {
                    b.HasOne("LockthreatCompliance.AuditProjects.AuditChecklist", "AuditChecklist")
                        .WithMany()
                    ...
                    b.HasOne("LockthreatCompliance.AuditProjects.AuditTemplate", "AuditTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("LockthreatCompliance.Storage.DocumentPath", b =>
                {
                    ...
                    b.HasOne("LockthreatCompliance.AuditProjects.AuditChecklist", null)
                        .WithMany("Attachments")
                        .HasForeignKey("AuditChecklistId");

                    b.HasOne("LockthreatCompliance.AuditProjects.AuditMeeting", null)
                        .WithMany("Attachments")
                        .HasForeignKey("AuditMeetingId");
                    ...
                    b.HasOne("LockthreatCompliance.AuditProjects.AuditProject", null)
                        .WithMany("Attachments")
                        .HasForeignKey("AuditProjectId");

                    b.HasOne("LockthreatCompliance.AuditProjects.AuditTemplate", null)
                        .WithMany("Attachments")
                        .HasForeignKey("AuditTemplateId");
