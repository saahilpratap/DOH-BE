...
namespace LockthreatCompliance.Migrations.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        ...
        public HostRoleAndUserCreator(LockthreatComplianceDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            {
                adminRoleForHost = _context.Roles.Add(new Role(null, StaticRoleNames.Host.Admin, StaticRoleNames.Host.Admin,(int)UserOriginType.admin) { IsStatic = true, IsDefault = true }).Entity;
            ...
            if (adminUserForHost == null)
            {
                var user = new User
                {
                    ...
                    Name = "admin",
                    Surname = "admin",
                    EmailAddress = "admin@emirsec.com",
