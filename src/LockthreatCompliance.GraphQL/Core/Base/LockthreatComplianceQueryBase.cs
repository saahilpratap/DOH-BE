...
namespace LockthreatCompliance.Core.Base
{
    public abstract class LockthreatComplianceQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected LockthreatComplianceQueryBase(string fieldName,
