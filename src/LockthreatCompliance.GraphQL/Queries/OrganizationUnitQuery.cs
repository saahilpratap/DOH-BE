...
using LockthreatCompliance.Core.Base;
using LockthreatCompliance.Core.Extensions;
using LockthreatCompliance.Dto;
using LockthreatCompliance.Types;

namespace LockthreatCompliance.Queries
{
    public class OrganizationUnitQuery : LockthreatComplianceQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
