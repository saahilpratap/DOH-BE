...
using MvvmHelpers;
using LockthreatCompliance.Authorization.Users.Profile;
using LockthreatCompliance.Authorization.Users.Profile.Dto;
using LockthreatCompliance.Commands;
using LockthreatCompliance.Core.Threading;
using LockthreatCompliance.Models.NavigationMenu;
using LockthreatCompliance.Services.Navigation;
using LockthreatCompliance.ViewModels.Base;
using Plugin.Media;
...
using LockthreatCompliance.Controls;
using LockthreatCompliance.Dto;
using LockthreatCompliance.Extensions;
using LockthreatCompliance.Localization;
using LockthreatCompliance.UI;
using LockthreatCompliance.UI.Assets;
using LockthreatCompliance.Views;
using DependencyResolver = LockthreatCompliance.Core.Dependency.DependencyResolver;

namespace LockthreatCompliance.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "LockthreatCompliance";
