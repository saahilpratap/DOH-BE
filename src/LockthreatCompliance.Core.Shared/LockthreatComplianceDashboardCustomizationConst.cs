...
{
    public class LockthreatComplianceDashboardCustomizationConsts
    {
        /// <summary>
        ...
        public class Widgets
        {
            public class Tenant
            {
                ...
                public const string TopEntityAssessmentsUserStats = "Widgets_Tenant_TopEntityAssessmentsUserStats";


                public const string EntityComplianceSummary = "Widgets_Tenant_EntityComplianceSummary";
                public const string TotalRiskStatistics = "Widgets_Tenant_TotalRiskStatistics";
                public const string KanbanInteractivityDemo = "Widgets_Tenant_KanbanInteractivityDemo";
                public const string ComplianceScoreSummary = "Widget_Compliance_Score_Summary";
            }
            ...
            public class Host
            {
                ...
                public const string TopEntityAssessmentsUserStats = "Widgets_Host_TopEntityAssessmentsUserStats";
            }
        }
