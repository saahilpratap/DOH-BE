...
{
    public class BusinessEntityActivatedEventHandler : IAsyncEventHandler<BusinessEntityActivatedEvent>, ITransientDependency
    {
        private readonly IRepository<UserOrganizationUnit, long> _userOrganizationUnitRepository;
        private readonly IRepository<OrganizationUnit, long> _organizationUnitRepository;
        private readonly UserManager _userManager;
        public BusinessEntityActivatedEventHandler(
        ...
        public async Task HandleEventAsync(BusinessEntityActivatedEvent eventData)
        {
