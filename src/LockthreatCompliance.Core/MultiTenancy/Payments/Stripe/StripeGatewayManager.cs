...
namespace LockthreatCompliance.MultiTenancy.Payments.Stripe
{
    public class StripeGatewayManager : LockthreatComplianceServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "LockthreatCompliance";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + LockthreatComplianceConsts.Currency;
        }
