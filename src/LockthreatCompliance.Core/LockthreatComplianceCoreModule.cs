...
using LockthreatCompliance.Authorization.Ldap;
...
using LockthreatCompliance.DashboardCustomization.Definitions;
using LockthreatCompliance.Debugging;
using LockthreatCompliance.DynamicEntityParameters;
using LockthreatCompliance.Features;
...
using LockthreatCompliance.WebHooks;

namespace LockthreatCompliance
{
    [DependsOn(
        typeof(LockthreatComplianceCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class LockthreatComplianceCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            LockthreatComplianceLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = LockthreatComplianceConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, LockthreatComplianceMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<LockthreatComplianceSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LockthreatComplianceCoreModule).GetAssembly());
        }
