...
namespace LockthreatCompliance.Authorization.Impersonation
{
    public class ImpersonationManager : LockthreatComplianceDomainServiceBase, IImpersonationManager
    {
