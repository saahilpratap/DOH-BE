...
{
    public class ExternalAuditDeactivatedEventHandler : IAsyncEventHandler<ExternalAuditDeactivatedEvent>, ITransientDependency
    {
        private readonly IRepository<UserOrganizationUnit, long> _userOrganizationUnitRepository;
        private readonly IRepository<OrganizationUnit, long> _organizationUnitRepository;
        private readonly UserManager _userManager;
        public ExternalAuditDeactivatedEventHandler(
        ...
        public async Task HandleEventAsync(ExternalAuditDeactivatedEvent eventData)
        {
