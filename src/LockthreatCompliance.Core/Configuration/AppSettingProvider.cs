...
using LockthreatCompliance.DashboardCustomization;
...
namespace LockthreatCompliance.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!LockthreatComplianceConsts.AllowTenantsToChangeEmailSettings)
            {
        ...
        private IEnumerable<SettingDefinition> GetTenantSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings, GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings, LockthreatComplianceConsts.MultiTenancyEnabled? "true":"false"), scopes: SettingScopes.Tenant),
                new SettingDefinition(AppSettings.UiManagement.Theme, GetFromAppSettings(AppSettings.UiManagement.Theme, "default"), isVisibleToClients: true, scopes: SettingScopes.All),
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(AppSettings.DashboardCustomization.Configuration +"."+ LockthreatComplianceDashboardCustomizationConsts.Applications.Mvc, mvcDefaultSettingsJson, scopes: SettingScopes.User, isVisibleToClients: true),
                new SettingDefinition(AppSettings.DashboardCustomization.Configuration +"."+ LockthreatComplianceDashboardCustomizationConsts.Applications.Angular, angularDefaultSettingsJson, scopes: SettingScopes.User, isVisibleToClients: true)
            };
        }
        ...
        public List<Dashboard> GetDefaultMvcDashboardViews()
        {
            ...
            return new List<Dashboard>
            {
                new Dashboard
                {
                    DashboardName = LockthreatComplianceDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            Name = LockthreatComplianceDashboardCustomizationConsts.DefaultPageName,
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Tenant.GeneralStats, // General Stats
                                    Height = 9,
                                    Width = 6,
                                    PositionX = 0,
                                    PositionY = 19
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Tenant.ProfitShare, // Profit Share
                                    Height = 13,
                                    Width = 6,
                                    PositionX = 0,
                                    PositionY = 28
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Tenant.MemberActivity, // Memeber Activity
                                    Height = 13,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 28
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Tenant.RegionalStats, // Regional Stats
                                    Height = 14,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 5
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Tenant.DailySales, // Daily Sales
                                    Height = 9,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 19
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Tenant.TopStats, // Top Stats
                                    Height = 5,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 0
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Tenant.SalesSummary, // Sales Summary
                                    Height = 14,
                                    Width = 6,
                                    PositionX = 0,
                                    PositionY = 5
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Tenant.TopEntityAssessmentsUserStats, // Top Entity Assessments User Stats
                                    Height = 5,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 0
                ...
                new Dashboard
                {
                    DashboardName = LockthreatComplianceDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Host.TopStats, // Top Stats
                                    Height = 6,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 0
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Host.TopEntityAssessmentsUserStats, // TopEntityAssessmentsUserStats
                                    Height = 6,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 0
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Host.IncomeStatistics, // Income Statistics
                                    Height = 11,
                                    Width = 7,
                                    PositionX = 0,
                                    PositionY = 6
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Host.RecentTenants, // Recent tenants
                                    Height = 10,
                                    Width = 5,
                                    PositionX = 7,
                                    PositionY = 17
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants, // Subscription expiring tenants
                                    Height = 10,
                                    Width = 7,
                                    PositionX = 0,
                                    PositionY = 17
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Host.EditionStatistics, // Edition statistics
                                    Height = 11,
                                    Width = 5,
                                    PositionX = 7,
                                    PositionY = 6
                    ...
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Tenant.TopEntityAssessmentsUserStats, // TopEntityAssessmentsUserStats
                                    Height = 4,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 0
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Tenant.MemberActivity, // Member Activity
                                    Height = 11,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 24
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Tenant.EntityComplianceSummary, // Entity Compliance Summary 
                                    Height = 10,
                                    Width = 6,
                                    PositionX = 0,
                                    PositionY = 35
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Tenant.TotalRiskStatistics, // Total Risk Statistics
                                    Height = 10,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 35
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Tenant.KanbanInteractivityDemo, // Kanban Interactivity Demo
                                    Height = 15,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 45
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Tenant.ComplianceScoreSummary, // Compliance Score Summary
                                    Height = 10,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 35
                    ...
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                ...
                                new Widget
                                {
                                    WidgetId = LockthreatComplianceDashboardCustomizationConsts.Widgets.Host.TopEntityAssessmentsUserStats, // Top Stats
                                    Height = 4,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 0
                                ...
                                {
                                    WidgetId =
                                        LockthreatComplianceDashboardCustomizationConsts.Widgets.Host.RecentTenants, // Recent tenants
                                    Height = 9,
                                    Width = 5,
                                    PositionX = 7,
                                    PositionY = 12
