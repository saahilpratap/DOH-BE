...
namespace LockthreatCompliance.Web.Authentication.JwtBearer
{
    public class LockthreatComplianceJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public LockthreatComplianceJwtSecurityTokenHandler()
        {
