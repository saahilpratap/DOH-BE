...
namespace LockthreatCompliance.Web.Security.Recaptcha
{
    public class RecaptchaValidator : LockthreatComplianceServiceBase, IRecaptchaValidator, ITransientDependency
    {
