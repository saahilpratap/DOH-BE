...
using LockthreatCompliance.Web.Helpers;

namespace LockthreatCompliance.Web.Controllers
{
    [AbpMvcAuthorize]
    public class TenantCustomizationController : LockthreatComplianceControllerBase
    {
        ...
        {
            var defaultLogo = "/Common/Images/Aamen.svg";
