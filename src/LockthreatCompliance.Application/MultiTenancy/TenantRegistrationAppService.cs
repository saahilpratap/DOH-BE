...
{
    public class TenantRegistrationAppService : LockthreatComplianceAppServiceBase, ITenantRegistrationAppService
    {
        ...
        public async Task<RegisterTenantOutput> RegisterTenant(RegisterTenantInput input)
        {
            ...
            using (CurrentUnitOfWork.SetTenantId(null))
            {
                ...
                var settings = new ThemeSettingsDto();
                ...
                using (var uow = UnitOfWorkManager.Begin())
                {
                    using (CurrentUnitOfWork.SetTenantId(tenantId))
                    {
                        ...
                        await themeCustomizer.UpdateUserUiManagementSettingsAsync(user.ToUserIdentifier(), settings);
                        uow.Complete();
                    }
                }
