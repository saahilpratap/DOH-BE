...
namespace LockthreatCompliance.DataExporting.Excel.NPOI
{
    public abstract class NpoiExcelExporterBase : LockthreatComplianceServiceBase, ITransientDependency
    {
