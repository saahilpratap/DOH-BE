...
namespace LockthreatCompliance.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : LockthreatComplianceServiceBase, ITransientDependency
    {
