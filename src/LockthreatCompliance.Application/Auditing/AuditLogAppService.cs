...
using EntityHistoryHelper = LockthreatCompliance.EntityHistory.EntityHistoryHelper;

namespace LockthreatCompliance.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : LockthreatComplianceAppServiceBase, IAuditLogAppService
    {
