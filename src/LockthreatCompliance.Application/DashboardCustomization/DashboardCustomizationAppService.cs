...
using LockthreatCompliance.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace LockthreatCompliance.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : LockthreatComplianceAppServiceBase, IDashboardCustomizationAppService
    {
