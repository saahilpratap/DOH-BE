...
namespace LockthreatCompliance.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : LockthreatComplianceAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<LockthreatComplianceDbContext> _migrator;
