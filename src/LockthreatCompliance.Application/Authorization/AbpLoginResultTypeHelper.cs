...
{
    public class AbpLoginResultTypeHelper : LockthreatComplianceServiceBase, ITransientDependency
    {
        public Exception CreateExceptionForFailedLoginAttempt(AbpLoginResultType result, string usernameOrEmailAddress, string tenancyName)
        {
            switch (result)
            {
                ...
                case AbpLoginResultType.UserIsNotActive:
                    ...
                    return new AbpAuthorizationException("Your Account is Locked !! <br> Please contact support.aamen@doh.gov.ae");
