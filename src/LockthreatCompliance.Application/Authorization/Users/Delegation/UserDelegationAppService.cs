...
namespace LockthreatCompliance.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : LockthreatComplianceAppServiceBase, IUserDelegationAppService
    {
