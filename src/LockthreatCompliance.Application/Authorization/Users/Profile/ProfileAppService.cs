...
using LockthreatCompliance.Authorization.Users.Profile.Cache;
using LockthreatCompliance.Authorization.Users.Profile.Dto;
using LockthreatCompliance.Friendships;
using LockthreatCompliance.Gdpr;
using LockthreatCompliance.Identity;
using LockthreatCompliance.Net.Sms;
using LockthreatCompliance.Security;
using LockthreatCompliance.Storage;
using LockthreatCompliance.Timing;
using Abp.Runtime.Security;

namespace LockthreatCompliance.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : LockthreatComplianceAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("LockthreatCompliance",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("LockthreatCompliance",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
        ...
        public async Task ChangePassword(ChangePasswordInput input)
        {
            ...
            {
               // user.EncryptPassword = SimpleStringCipher.Instance.Encrypt(input.NewPassword);
