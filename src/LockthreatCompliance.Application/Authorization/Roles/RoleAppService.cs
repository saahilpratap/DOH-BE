...
namespace LockthreatCompliance.Authorization.Roles
{
    ...
    public class RoleAppService : LockthreatComplianceAppServiceBase, IRoleAppService
    {
        ...
        public async Task<GetRoleForEditOutput> GetRoleForEdit(NullableIdDto input)
        {
            ...
            if (input.Id.HasValue) //Editing existing role?
            {
                ...
                roleEditDto.RoleTypeId =(role.Type!=null)?(int)role.Type:0;
            }
            else
            {
        ...
        protected virtual async Task UpdateRoleAsync(CreateOrUpdateRoleInput input)
        {
            ...
            role.Type =(UserOriginType)input.Role.RoleTypeId;
        ...
        {
            var role = new Role(AbpSession.TenantId, input.Role.DisplayName, input.Role.DisplayName,input.Role.RoleTypeId) { IsDefault = input.Role.IsDefault };
            role.Type =(UserOriginType)input.Role.RoleTypeId;
