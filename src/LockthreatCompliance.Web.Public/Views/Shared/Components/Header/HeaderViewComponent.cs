...
using LockthreatCompliance.Web.Session;

namespace LockthreatCompliance.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : LockthreatComplianceViewComponent
    {
