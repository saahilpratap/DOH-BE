...
namespace LockthreatCompliance.Web.Public.Startup
{
    [DependsOn(
        typeof(LockthreatComplianceWebCoreModule)
    )]
    public class LockthreatComplianceWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public LockthreatComplianceWebFrontEndModule(IWebHostEnvironment env, LockthreatComplianceEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LockthreatComplianceWebFrontEndModule).GetAssembly());
        }
    }
}
