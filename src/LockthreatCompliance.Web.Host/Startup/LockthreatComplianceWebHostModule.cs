...
using LockthreatCompliance.Web.Host.Controllers;
...
namespace LockthreatCompliance.Web.Startup
{
    ...
    public class LockthreatComplianceWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public LockthreatComplianceWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LockthreatComplianceWebHostModule).GetAssembly());
